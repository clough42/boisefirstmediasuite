...
rem "%SYSTEMROOT%\Microsoft.NET\Framework\v2.0.50727\regasm" /u "MatrixControl.dll"
"%SYSTEMROOT%\Microsoft.NET\Framework64\v2.0.50727\regasm" /u "MatrixControl.dll"
